...
class Login extends Component {
  ...
  render() {
    ...
    if(configs.mode === 'development') {
        ...
        <MuiThemeProvider muiTheme={muiTheme}>
          <div style={{...styles.main, backgroundColor: primary1Color}}>
            <Card style={styles.card}>
              <img className="App-logo" src={logoImage} alt="Logo" style={styles.logo}/>
              ...
              <form onSubmit={handleSubmit(this.login)}>
                ...
                <CardActions>
                  <RaisedButton type="submit" primary disabled={submitting} label={translate('aor.auth.sign_in')}
                                fullWidth/>
                </CardActions>
              </form>
            </Card>
      ...
      return (
        <MuiThemeProvider muiTheme={muiTheme}>
          <div style={styles.redirect}>Redirecting to login...</div>
        </MuiThemeProvider>
      );
    }
  }
